    ...
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <div className="flex flex-col items-center text-center animate-fade-in">
          <span className="inline-block mb-3 font-medium bg-accent/10 text-accent py-1 px-3 rounded-full">Welcome to my portfolio</span>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6">
            I'm <span className="text-gradient">Maniteja Lenkalapelly</span>
          </h1>
          ...
          <p className="text-lg max-w-2xl mb-8 text-muted-foreground">
            Passionate software developer skilled in Python, C++, Java and full-stack development, with strong team collaboration and leadership abilities.
          </p>
